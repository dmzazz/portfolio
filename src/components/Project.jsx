...
const projects = [
  {
    id: "selfcare",
    title: "SelfCare",
    text: "Self-Care is a website-based information system so that adolescents can gain insight into psychological problems starting from learning to recognize themselves, knowing about what psychology is and the impact that will be received if ignored and understand when to consult psychology.",
    link: "https://github.com/dmzazz/capstone-kel-5",
    techStack: "ReactJs, Bootstrap, JSON Server",
    linkText: "View Code",
    imgSrc: selfcare,
    aos: "fade-left",
  },
  {
    ...
    text: "An online invitation in the form of a website to make it easier for users to invite relatives to remote weddings or circumcisions.",
  ...
  },
  {
    id: "warehouse",
    title: "Warehouse",
    text: "An application that functions to record incoming and outgoing goods.",
  ...
  // },
  {
    ...
    link: "#batch-tracker",
    techStack: "NextJS, DotNet, MySQL, TailwindCSS, DaisyUI",
    linkText: "Private",
    imgSrc: batchtracker,
    aos: "fade-left",
  },
              ...
              <div className="card-body pb-5 px-5 p-lg-0">
                ...
                <p className="fw-semibold">
                  {project.techStack.split(", ").map((tech, index) => (
                    <span key={index} className="border border-gray-400 px-2 py-1 rounded mx-1">
                      {tech}
                    </span>
                  ))}
                </p>
